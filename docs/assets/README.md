...
The generation model label is
[Gemma 4 E2B IT](https://huggingface.co/google/gemma-4-E2B-it), which is also the model
`./workshop prepare` installs; see [model references](../../models/README.md).
