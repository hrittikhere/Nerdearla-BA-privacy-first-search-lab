...
sbx, Model Context Protocol, OpenCode, Ollama, Python, Qdrant, and SQLite. The SVG
paths were sourced from [Simple Icons](https://simpleicons.org/) and retain their
published brand colors. The marks remain trademarks of their respective owners.
